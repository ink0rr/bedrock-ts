...
export type AnimationIdentifier = LiteralUnion<
  ...
  | "animation.location_pointer_idle.spin"
  | "animation.location_pointer_selected.spin"
  | "animation.magma_cube.move"
  | "animation.map_marker.idle"
  ...
  | "animation.ruler_idle.spin"
  | "animation.ruler_pointer_selected.spin"
