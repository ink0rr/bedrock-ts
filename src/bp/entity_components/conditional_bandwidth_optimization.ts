...
export type EntityConditionalBandwidthOptimizationComponent = {
   ...
   */
  conditional_values?:
    | Array<EntityConditionalBandwidthOptimizationComponent.ConditionalValues>
    | EntityConditionalBandwidthOptimizationComponent.ConditionalValues;
  /**
   * The object containing the default bandwidth optimization values.
   */
  default_values?:
    | Array<EntityConditionalBandwidthOptimizationComponent.DefaultValues>
    | EntityConditionalBandwidthOptimizationComponent.DefaultValues;
};
